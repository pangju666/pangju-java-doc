...
## 说明
我定义[`ScanRedisTemplate`](/v2/framework/redis/template)的自动装配。

我自动装配了[`StringScanRedisTemplate`](/v2/framework/redis/template#stringscanredistemplate)和
[`JsonScanRedisTemplate`](/v2/framework/redis/template#jsonscanredistemplate)两种Bean。
