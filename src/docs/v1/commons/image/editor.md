...
> 
> 所有操作都是基于图像的[视觉尺寸](/v1/commons/image/model#获取视觉尺寸)。
...
支持根据[方向](/v1/commons/image/enums#旋转方向)或角度两种旋转方式。
...
支持根据[方向](/v1/commons/image/enums#翻转方向)翻转图像。
...
图像水印方向，请参考[文档](/v1/commons/image/enums#水印方向)
