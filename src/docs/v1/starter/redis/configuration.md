...
## 说明
我定义[`ScanRedisTemplate`](/v1/framework/redis/template)的自动装配。

我自动装配了[`StringScanRedisTemplate`](/v1/framework/redis/template#stringscanredistemplate)和
[`JsonScanRedisTemplate`](/v1/framework/redis/template#jsonscanredistemplate)两种Bean。
