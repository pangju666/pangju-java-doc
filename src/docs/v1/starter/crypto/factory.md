...
> 
> 也可以使用[`CryptoAlgorithm`](/v1/starter/crypto/enums)结合[`StaticSpringContext`](/v1/starter/spring/context)来根据算法类型获取。
> 
> ```java
...
> 
> [RSA密钥文档](/v1/commons/crypto/key#从base64编码字符串构建)
...
### 替换RSA默认加密方案
`RSA`加密工厂可以修改默认的加密方案，默认使用`RSA/ECB/OAEPWithSHA-256AndMGF1Padding`，具体说明请查看[相关文档](/v1/commons/crypto/transformation)。
