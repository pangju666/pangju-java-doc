...
<script setup>
const frameworkBootVersion = import.meta.env.VITE_V1_FRAMEWORK_BOOT_STARTER_VERSION;
const springBootVersion = import.meta.env.VITE_V1_SPRING_BOOT_VERSION;
...
| framework-starter-json              |              `JSON`模块               |
| framework-starter-json-crypto       |             `JSON`加解密模块             |
